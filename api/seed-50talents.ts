...
const trainers = [
  { name: 'Anas El Alami', img: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100' },
  { name: 'Fatima Bouchaara', img: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100' },
  { name: 'Mehdi Choukri', img: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100' },
  { name: 'Hassan Bennani', img: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100' },
  { name: 'Leila Mansouri', img: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100' },
  { name: 'Youssef Karim', img: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100' },
  { name: 'Amina Khalif', img: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100' },
  { name: 'Omar Nassar', img: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100' },
];
